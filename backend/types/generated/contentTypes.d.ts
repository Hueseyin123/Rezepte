...
export interface ApiBewertungBewertung extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bewertung_text: Schema.Attribute.Text;
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rezepte: Schema.Attribute.Relation<'oneToOne', 'api::rezepte.rezepte'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    rezeptes: Schema.Attribute.Relation<'oneToMany', 'api::rezepte.rezepte'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRezepteRezepte extends Struct.CollectionTypeSchema {
  collectionName: 'rezeptes';
  info: {
    displayName: 'Rezepte';
    pluralName: 'rezeptes';
    singularName: 'rezepte';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Rezept: Schema.Attribute.Text & Schema.Attribute.Required;
    RezeptNamen: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::rezepte.rezepte': ApiRezepteRezepte;
